    ...
    <View style={styles.container}>
      ...
      <Card>
        <View style={{marginHorizontal: 37}}>
          ...
          {isVerified ? (
            <Text style={{marginTop: 24, fontSize: 14, fontWeight: 'normal'}}>
          ...
          <Text
            ...
            {`+91 XXXXXX${mobile[mobile.length - 4]}${
              mobile[mobile.length - 3]
            }${mobile[mobile.length - 2]}${mobile[mobile.length - 1]}`}
          </Text>
          <View style={{flexDirection: 'row', marginTop: 21}}>
            <Text
              onPress={onResendOtp}
              style={{fontSize: 14, fontWeight: 'bold', color: '#005082'}}>
              {'RESEND OTP'}
            </Text>
          </View>
        </View>
        ...
        <TouchableOpacity
          ...
          {!isverifyLoading && (
            <Text
              ...
              {isVerified && !matchError ? 'VERIFY' : 'TRY AGAIN'}
            </Text>
          )}
        </TouchableOpacity>
      </View>
