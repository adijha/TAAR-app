      ...
      <View style={{flex: 1}}>
        <FlatList
          ...
          renderItem={({item, index}) => (
            <TouchableOpacity
              onPress={() => this.nameTap(item.photo, item.firstname, item.id)}>
        ...
        <View
          ...
          <View
            style={[
              ...
              {
                borderRadius: 35,
                marginTop: !this.state.showAddButton
                  ? deviceHeight * (Platform.OS === 'ios' ? 0.46 : 0.19)
                  : deviceHeight * (Platform.OS === 'ios' ? 0.0 : -0.06),
              },
            ]}>
            {this.state.showAddButton ? (
              <View>
