      ...
      <View style={styles.mainContainer}>
        {false ? (
          ...
          <View style={styles.dummyPic}>
            <Image source={cameraIcon} style={{width: 19, height: 17}} />
          </View>
        )}
        <Text
          style={{
        ...
        <View style={{marginTop: 20}}>
          <TouchableOpacity
            ...
            style={[
              styles.btn,
              {borderColor: groupName.length !== 0 ? '#39B54A' : '#000'},
            ]}>
            <Text
              style={[
                styles.btnText,
                {color: groupName.length !== 0 ? '#39B54A' : '#000'},
              ]}>
              DONE
            </Text>
          </TouchableOpacity>
      ...
      <KeyboardAvoidingView
        ...
        <View style={styles.footer}>
          <Text style={styles.footerGroupText}>
            Group Users {dummyUserSelectedgroup.length}
          </Text>
              ...
              renderItem={({item, index}) => (
                <View style={{marginTop: 3}}>
                  <View style={styles.crossView}>
                    <Image style={{width: 8, height: 8}} source={crossIcon} />
                  </View>
