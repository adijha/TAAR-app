    ...
    <View style={{flex: 1}}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('SingleChat')}>
            <View style={styles.singleChatContainer}>
              ...
              <View style={styles.chatTextContainer}>
                ...
                <Text
                  style={{fontSize: 13, fontWeight: '500', color: '#D53B3B'}}>
                  3 Missed Calls
                </Text>
      ...
      <View
        style={{
          ...
          marginTop:
            deviceHeight *
            (Platform.OS === 'ios' ? (showAddButton ? 0.45 : 0.2) : 0.5),
        }}>
        <View
          style={[
            styles.addButton,
            {
              borderRadius: 35,
              marginTop: deviceHeight * (Platform.OS === 'ios' ? 0.46 : 0.19),
            },
          ]}>
          <TouchableOpacity onPress={onPressNewCall}>
            <View
              style={[
